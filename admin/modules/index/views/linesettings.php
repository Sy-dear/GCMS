...
class View extends \Gcms\Adminview
{
    ...
    public function render($config)
    {
        ...
        $fieldset->add('text', array(
            ...
            'comment' => '{LNG_for login by LINE account} <a href="https://www.goragod.com/index.php?module=knowledge&id=3903" target=_blank class=icon-help></a>',
        ...
        $fieldset->add('text', array(
            ...
            'comment' => '{LNG_send message to user When a user adds LINE&#039;s official account as a friend} <a href="https://www.goragod.com/index.php?module=knowledge&id=3904" target=_blank class=icon-help></a>',
